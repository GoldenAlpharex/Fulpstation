/datum/job/mechanic
	...
	display_order = JOB_DISPLAY_ORDER_ATMOSPHERIC_TECHNICIAN // Should display right after Atmos techs
...
/obj/item/clothing/under/rank/engineering/mechanic
	...
	icon = 'fulp_modules/jobs/mechanic/icons/clothing_worn.dmi'
	worn_icon = 'fulp_modules/jobs/mechanic/icons/clothing_worn.dmi'
	icon_state = "mechanic"
