...
/datum/controller/subsystem/mapping/Initialize(timeofday)
	...
	///////// FULP-ONLY STARTS -- Generating the Asteroid Z-Level - GoldenAlpharex -- FULP-ONLY STARTS /////////
	add_asteroid_z_level()

	///////// FULP-ONLY ENDS -- Generating the Asteroid Z-Level - GoldenAlpharex -- FULP-ONLY ENDS /////////
